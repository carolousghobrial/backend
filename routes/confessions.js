...
app.post(
  "/api/confessions/schedule",
  authenticateToken,
  requirePortalMatchOrRoles("user_id", ["priest", "coordinator"]),
  async (req, res) => {
    try {
      const {
        user_id,
      ...
      const { data: confession, error: confessionError } =
...
// Confirm confession
app.patch(
  "/api/confessions/:confessionId/confirm",
  authenticateToken,
  requireConfessionAdmin,
  async (req, res) => {
    try {
...
// Cancel confession
app.patch(
  "/api/confessions/:confessionId/cancel",
  authenticateToken,
  requireConfessionAdmin,
  async (req, res) => {
    try {
...
// Complete confession
app.patch(
  "/api/confessions/:confessionId/complete",
  authenticateToken,
  requireConfessionAdmin,
  async (req, res) => {
    try {
...
app.get(
  ...
  async (req, res) => {
    try {
      ...
      if (startDate)
        statusQuery = statusQuery.gte("confession_date", startDate);
...
app.get(
  "/api/users/:userId/confessions",
  authenticateToken,
  requireParamPortalMatchOrRoles("userId", ["priest", "coordinator"]),
  async (req, res) => {
    try {
...
app.get(
  "/getUnconfirmedConfessionRequest",
  authenticateToken,
  requireConfessionAdmin,
  async (req, res) => {
    const { data, error } = await supabase.supabase
...
app.post(
  "/confirmtConfession/:reservationId",
  authenticateToken,
  requireConfessionAdmin,
  async (req, res) => {
